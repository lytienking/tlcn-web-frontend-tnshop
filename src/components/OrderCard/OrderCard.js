        ...
        <Grid container spacing={2}>
          <Grid item>
            <ButtonBase className={classes.image}>
              <img className={classes.img} alt="complex" src={props.order.productID.images} />
            </ButtonBase>
          </Grid>
            ...
            <Grid item xs container direction="column" spacing={2}>
              ...
              <Grid item>
                <Typography variant="body2" style={{ cursor: 'pointer' }}>
                  Trạng thái : {groupByOrderStatus(props.orderDetail.orderDetail.status)}
                </Typography>
              </Grid>
            </Grid>
            <Grid item>
              <Typography variant="subtitle1">{props.order.productID.price}.000đ</Typography>
              <Typography >
                {showRating(props)}
              </Typography>
            </Grid>
