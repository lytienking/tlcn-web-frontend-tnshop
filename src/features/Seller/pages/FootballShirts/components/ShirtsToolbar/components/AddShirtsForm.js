            ...
            try {
                ...
                if (response.success) {
                    ...
                    let res = this.props.dispatch(
                        getShirtsSeller(response.shirts)
                    );
                    console.log(res);
                }
            } catch (error) {
                        ...
                        <Form>
                            <Grid container spacing={3}>
                                ...
                                <Grid item md={12}>
                                    ...
                                    >
                                        <DraggableUploader title="Chọn ảnh bìa" files={this.receiveFileImg}/>
                                    </Grid>
                                </Grid>
                                <Grid
                                    item
                                ...
                                >
                                    <DraggableUploader title="Chọn ảnh chụp sách" files={this.receiveFilePrev} />
                                </Grid>
                                <Grid
                                    item
                                    md={12}
