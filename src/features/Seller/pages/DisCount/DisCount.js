                ...
                <form>
                    <div className="row">
                        <div className="col-25">
                            <input type="text" onChange={(event)=>{setAmount(event.target.value)}}  id="fname" name="firstname" placeholder="Số lượng" required/>
                        </div>
                    </div>
                    <div className="row">
                        <div className="col-25">
                            <input type="text" id="lname" onChange={(event)=>{setPrice(event.target.value)}} name="lastname" placeholder="Số tiền" required/>
                        </div>
                    </div>
                </form>
            </div>
