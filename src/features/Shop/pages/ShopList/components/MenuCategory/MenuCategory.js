                ...
                <CardContent>
                    ...
                    <div className="MenuCategory">
                        <ul>
                            ...
                            <li>
                                <NavLink exact to={`/shop/${"605094599026001c60ab9919"}`}  className="item" activeClassName="item--active">
                                    <img src={Thum2} alt="logo" ></img>
                                    Giày thi đấu
                                </NavLink>
                            </li>
                            <li>
                                <NavLink exact to={`/shop/${"605094d29026001c60ab991a"}`}  className="item" activeClassName="item--active">
                                    <img src={Thum4} alt="logo" ></img>
                                    Bóng thi đấu
                                </NavLink>
                            </li>
                            <li>
                                <NavLink exact to={`/shop/${"605094f19026001c60ab991b"}`}  className="item" activeClassName="item--active">
